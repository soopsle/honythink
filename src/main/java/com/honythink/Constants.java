...
public class Constants {
    ...
    public static final String XLS_WORKBOOK_EXPORT_CUSTOMER = "summary_customer.xls";
    public static final String XLS_WORKBOOK_EXPORT_SELF = "summary_self.xls";
    public static final String XLS_WORKBOOK_EXPORT_CSIX = "summary_csix.xls";
